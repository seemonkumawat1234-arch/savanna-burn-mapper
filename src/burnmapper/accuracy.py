...
Deliberately reports the full confusion matrix plus per-class producer's and
user's accuracy, not just overall accuracy. Overall accuracy alone is
misleading on burnt-area maps: savanna scenes are often 80 percent or more
unburnt, so a classifier that predicts "unburnt" everywhere scores well on OA
while finding no fire at all.
"""
